AlphabeticalDividersExampleAssistant = Class.create( ExampleAssistantBase, {
	...
	setup : function($super){
		...
		this.controller.setupWidget('examples', 
									{
										itemTemplate: 'alphabetical-dividers-example/entry',
										dividerTemplate: 'alphabetical-dividers-example/divider',
